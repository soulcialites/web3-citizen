...
export interface ExpirationEnforcerInterface extends utils.Interface {
  contractName: "ExpirationEnforcer";
  functions: {
...
export interface ExpirationEnforcer extends BaseContract {
  contractName: "ExpirationEnforcer";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExpirationEnforcerInterface;
