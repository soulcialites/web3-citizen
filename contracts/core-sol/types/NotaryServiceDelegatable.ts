...
export interface NotaryServiceDelegatableInterface extends utils.Interface {
  contractName: "NotaryServiceDelegatable";
  functions: {
...
export interface NotaryServiceDelegatable extends BaseContract {
  contractName: "NotaryServiceDelegatable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NotaryServiceDelegatableInterface;
  ...
  callStatic: {
    ...
    issue(newCitizen: string, overrides?: CallOverrides): Promise<void>;
