...
export interface ResolverENSInterface extends utils.Interface {
  contractName: "ResolverENS";
  functions: {
...
export interface ResolverENS extends BaseContract {
  contractName: "ResolverENS";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResolverENSInterface;
