...
require('dompurify');
require('is-svg');
var urlJoinTs = require('url-join-ts');
var ensAvatar = require('@ensdomains/ens-avatar');
var wagmi = require('wagmi');
var ENS = _interopDefault(require('@ensdomains/ens-contracts/artifacts/contracts/registry/ENS.sol/ENS.json'));
var Resolver = _interopDefault(require('@ensdomains/ens-contracts/artifacts/contracts/resolvers/Resolver.sol/Resolver.json'));
var PublicResolver = _interopDefault(require('@ensdomains/ens-contracts/artifacts/contracts/resolvers/PublicResolver.sol/PublicResolver.json'));
var ReverseRegistrar = _interopDefault(require('@ensdomains/ens-contracts/artifacts/contracts/registry/ReverseRegistrar.sol/ReverseRegistrar.json'));
var ethEnsNamehash = _interopDefault(require('eth-ens-namehash'));
...
function resolveURI(uri, customGateway) {
  ...
  if ((protocol === 'ipns:/' || subpath === 'ipns/') && target) {
    return {
      uri: urlJoinTs.urlJoin(ipfsGateway, IPNS_SUBPATH, target, subtarget),
      isOnChain: false,
      isEncoded: false
    };
    ...
    return {
      uri: urlJoinTs.urlJoin(ipfsGateway, IPFS_SUBPATH, target, subtarget),
      isOnChain: false,
      isEncoded: false
    };
  } else {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return _context2.abrupt("return", ensAvatar.utils.getImageURI({
              metadata: _metadata
            }));

          case 6:
            // parse retrieved avatar uri
            _utils$parseNFT = ensAvatar.utils.parseNFT(avatarURI), chainID = _utils$parseNFT.chainID, namespace = _utils$parseNFT.namespace, contractAddress = _utils$parseNFT.contractAddress, tokenID = _utils$parseNFT.tokenID; // detect avatar spec by namespace
...
exports.namehash = ethEnsNamehash;
exports.parseAvatarString = parseAvatarString;
exports.useEnsContractRead = useEnsContractRead;
exports.useEnsContractWrite = useEnsContractWrite;
exports.usePublicResolverContract = usePublicResolverContract;
exports.usePublicResolverRead = usePublicResolverRead;
exports.usePublicResolverWrite = usePublicResolverWrite;
exports.useResolverContract = useResolverContract;
exports.useResolverContractRead = useResolverContractRead;
exports.useResolverContractWrite = useResolverContractWrite;
exports.useReverseRegistrarContractRead = useReverseRegistrarContractRead;
exports.useReverseRegistrarContractWrite = useReverseRegistrarContractWrite;
//# sourceMappingURL=ens-wagmi.cjs.development.js.map
