...
import { useBalance, useBlockNumber, useEnsName, useEnsAddress, useConnect, useAccount, useSigner } from 'wagmi';
...
var EnsName = function EnsName(_ref) {
  ...
  if (isError || !isLoading) return createElement(Address, {
    truncate: true,
    address: address,
    className: classes
  });
...
var EnsAddress = function EnsAddress(_ref) {
  ...
  var _useEnsAddress = useEnsAddress({
    name: name
  }),
...
export { Address, Balance, BlockNumber, EnsAddress, EnsName, IpfsUriImageBackgroundRender, IpfsUriImageRender, IsWalletConnected, WalletAddress, WalletBalance, WalletEnsAddress, WalletEnsName, WalletNonce };
