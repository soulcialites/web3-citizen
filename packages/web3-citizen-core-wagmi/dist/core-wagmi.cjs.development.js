...
var CitizenAlpha = _interopDefault(require('@web3-citizen/core-sol/abis/contracts/CitizenAlpha.sol/CitizenAlpha.json'));
var coreWagmi = require('@turbo-eth/core-wagmi');
var reactHookForm = require('react-hook-form');
var ensWagmi = require('@turbo-eth/ens-wagmi');
var Notary = _interopDefault(require('@web3-citizen/core-sol/abis/contracts/Notary/Notary.sol/Notary.json'));
var Nation = _interopDefault(require('@web3-citizen/core-sol/abis/contracts/Nation/Nation.sol/Nation.json'));
var NotaryServiceDelegatable = _interopDefault(require('@web3-citizen/core-sol/abis/contracts/Notary/NotaryServiceDelegatable.sol/NotaryServiceDelegatable.json'));
var TrustToken = _interopDefault(require('@web3-citizen/core-sol/abis/contracts/experiments/TrustToken.sol/TrustToken.json'));

var _reverseLookup;
var NOTARY = /*#__PURE__*/ethers.utils.keccak256( /*#__PURE__*/ethers.utils.toUtf8Bytes('NOTARY'));
var FOUNDER = /*#__PURE__*/ethers.utils.keccak256( /*#__PURE__*/ethers.utils.toUtf8Bytes('FOUNDER'));
var TREASURY = /*#__PURE__*/ethers.utils.keccak256( /*#__PURE__*/ethers.utils.toUtf8Bytes('TREASURY'));
var LABS = /*#__PURE__*/ethers.utils.keccak256( /*#__PURE__*/ethers.utils.toUtf8Bytes('LABS'));
var lookup = {
  NOTARY: NOTARY,
  FOUNDER: FOUNDER,
  TREASURY: TREASURY,
...
var CitizenLink = function CitizenLink(_ref) {
  ...
  return React.createElement(coreWagmi.Address, {
    className: classes,
    address: data,
    truncate: true
  });
...
var FormCitizenEnsUpdate = function FormCitizenEnsUpdate(_ref) {
  ...
  var contractResolver = ensWagmi.useResolverContract(contractAddress);

  var _React$useState = React.useState(),
      inputs = _React$useState[0],
      setInputs = _React$useState[1];

  var _useResolverContractW = ensWagmi.useResolverContractWrite(contractAddress, 'multicall', [inputs]),
...
function useLogError(error) {
  React.useEffect(function () {// console.log(error);
  }, [error]);
}

function useLogTransactionWrite(data) {
  React.useEffect(function () {// console.log(data);
  }, [data]);
}
...
var NationFormDisableRole = function NationFormDisableRole(_ref) {
  ...
  var _useNationWrite = useNationWrite(contractAddress, 'disableRole', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(watchAllFields.role))]),
      write = _useNationWrite.write,
  ...
  }, "Role"), React.createElement("input", Object.assign({
    className: "input",
    placeholder: "LABS"
  }, register('role', {
    required: true
...
var NationFormEnableRole = function NationFormEnableRole(_ref) {
  ...
  var _useNationWrite = useNationWrite(contractAddress, 'enableRole', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(watchAllFields.role)), ethers.utils.keccak256(ethers.utils.toUtf8Bytes(watchAllFields.adminRole))]),
      write = _useNationWrite.write,
      error = _useNationWrite.error,
      data = _useNationWrite.data;
  ...
  return React.createElement("div", {
    ...
    className: "label my-2 block"
  }, "Admin Role"), React.createElement("input", Object.assign({
    className: "input",
    placeholder: "FOUNDER"
  }, register('adminRole', {
    required: true
...
var NationFormHasRole = function NationFormHasRole(_ref) {
  ...
  var _useNationWrite = useNationWrite(contractAddress, 'hasRole', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(watchAllFields.role)), watchAllFields == null ? void 0 : watchAllFields.citizen]),
      write = _useNationWrite.write,
      error = _useNationWrite.error,
      data = _useNationWrite.data;
  ...
  }, React.createElement(InputWithSideLabel, {
    name: "role",
    placeholder: "FOUNDER",
    label: "Role",
    register: register
  ...
  }, "Status:"), ' ', data ? 'Yes' : 'No'))), React.createElement("button", {
    className: "btn btn-default my-3 w-full",
    type: "submit"
  }, label)));
};
...
var NationFormRoleGrant = function NationFormRoleGrant(_ref) {
  ...
  var _useNationWrite = useNationWrite(contractAddress, 'grantRole', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(watchAllFields.role)), watchAllFields.citizen]),
      write = _useNationWrite.write,
      error = _useNationWrite.error,
      data = _useNationWrite.data;
...
var NationFormRoleRevoke = function NationFormRoleRevoke(_ref) {
  ...
  var _useNationWrite = useNationWrite(contractAddress, 'revokeRole', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(watchAllFields.role)), watchAllFields.citizen]),
      write = _useNationWrite.write,
      error = _useNationWrite.error,
      data = _useNationWrite.data;
...
var NationRoleAdminRole = function NationRoleAdminRole(_ref) {
  ...
  var _useNationRead = useNationRead(contractAddress || '', 'getRoleAdmin', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(role))]),
...
var NationRoleStatus = function NationRoleStatus(_ref) {
  ...
  var _useNationRead = useNationRead(contractAddress || '', 'roleStatus', [ethers.utils.keccak256(ethers.utils.toUtf8Bytes(role || ''))]),
      data = _useNationRead.data,
      isError = _useNationRead.isError;
...
var NotaryServiceDelegatableFormClaimDelegate = function NotaryServiceDelegatableFormClaimDelegate(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: "btn btn-default my-3 w-full",
    type: "submit"
  }, label)), signatures && React.createElement("div", {
    className: "text-sm"
  }, React.createElement("span", {
    className: "block break-all"
  }, "Delegation: ", React.createElement("br", null), " ", signatures.delegation), React.createElement("span", {
    className: "block break-all"
  }, "Invocation: ", React.createElement("br", null), " ", signatures.invocation)));
};
...
var NotaryServiceDelegatableFormClaimInvocation = function NotaryServiceDelegatableFormClaimInvocation(_ref) {
  ...
  return React.createElement("div", {
  ...
  }, "Delegation"), React.createElement("input", Object.assign({
    className: "input",
    placeholder: "0x0"
  }, register('delegation', {
    required: true
    ...
    className: "text-sm font-semibold my-2"
  }, "Invocation"), React.createElement("input", Object.assign({
    className: "input",
    placeholder: "0x0"
  }, register('invocation', {
    required: true
...
function useCitizenGetMetadata(address, walletAddress, tokenId) {
  ...
  var _useContractRead = wagmi.useContractRead({
    addressOrName: address,
    contractInterface: CitizenAlpha
  }, 'tokenURI', {
    args: [tokenId]
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return ensWagmi.parseAvatarString(walletAddress, result.image, provider);
...
exports.CitizenLink = CitizenLink;
exports.FormCitizenEnsUpdate = FormCitizenEnsUpdate;
exports.FormCitizenIssue = FormCitizenIssue;
exports.FormCitizenRevoke = FormCitizenRevoke;
exports.NationFormDisableRole = NationFormDisableRole;
exports.NationFormEnableRole = NationFormEnableRole;
exports.NationFormHasRole = NationFormHasRole;
exports.NationFormIsFounder = NationFormIsFounder;
exports.NationFormRoleGrant = NationFormRoleGrant;
exports.NationFormRoleRevoke = NationFormRoleRevoke;
exports.NationHasRole = NationHasRole;
exports.NationIsFounder = NationIsFounder;
exports.NationRoleAdminRole = NationRoleAdminRole;
exports.NationRoleStatus = NationRoleStatus;
exports.NotaryFormGrantPermissions = NotaryFormGrantPermissions;
exports.NotaryFormIsNotary = NotaryFormIsNotary;
exports.NotaryFormRevokePermissions = NotaryFormRevokePermissions;
exports.NotaryIsNotary = NotaryIsNotary;
exports.NotaryServiceDelegatableFormClaim = NotaryServiceDelegatableFormClaim;
exports.NotaryServiceDelegatableFormClaimDelegate = NotaryServiceDelegatableFormClaimDelegate;
exports.NotaryServiceDelegatableFormClaimInvocation = NotaryServiceDelegatableFormClaimInvocation;
exports.TrustTokenClaim = TrustTokenClaim;
exports.constants = constants;
exports.lookup = lookup;
exports.reverseLookup = reverseLookup;
exports.useCitizenAlphaRead = useCitizenAlphaRead;
exports.useCitizenAlphaWrite = useCitizenAlphaWrite;
exports.useCitizenGetMetadata = useCitizenGetMetadata;
exports.useNationContract = useNationContract;
exports.useNationRead = useNationRead;
exports.useNationWrite = useNationWrite;
exports.useNotaryContract = useNotaryContract;
exports.useNotaryRead = useNotaryRead;
exports.useNotaryServiceDelegatableContract = useNotaryServiceDelegatableContract;
exports.useNotaryServiceDelegatableRead = useNotaryServiceDelegatableRead;
exports.useNotaryServiceDelegatableWrite = useNotaryServiceDelegatableWrite;
exports.useNotaryWrite = useNotaryWrite;
exports.useTrustTokenContract = useTrustTokenContract;
exports.useTrustTokenRead = useTrustTokenRead;
exports.useTrustTokenWrite = useTrustTokenWrite;
